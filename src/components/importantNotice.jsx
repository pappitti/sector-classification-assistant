function Warning({acknowledgeWarning}) {
    return (
        <div className="w-full flex flex-wrap justify-start p-2">
           ...
           <p className="w-full text-start py-1">However, running a machine-learning model on your device requires downloading the model first. Models are downloaded from the HuggingFace hub; <a href="https://huggingface.co/Xenova/bge-small-en-v1.5">bge-small-en-v1.5</a> is downloaded by default. We kept the option to use another model, <a href="https://huggingface.co/Xenova/all-MiniLM-L6-v2">all-MiniLM-L6-v2</a>, which may yield better results based on our tests. This app does not use cookies.</p>
           <p className="w-full text-start py-1">This app is a demo built to illustrate real-life use cases of AI, working exclusively with basic building blocks in order to demystify this technology. Read the blog post <a href="https://www.pitti.io/blogs/ELIAAM/sector-classification">here</a>. The code of this app is available <a href="https://github.com/pappitti/sector-classification-assistant">here</a>.</p>
