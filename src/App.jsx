      ...
      {model &&
        <div className="relative w-full flex-grow px-4 py-10 max-w-[1280px] m-auto">
          ...
          <div className="mt-10 text-sm italic">
            ...
            <p className="w-full text-start py-1">More powerful and/or finetuned models would be necessary to completely replace humans at this task. To allow inference on your device, we focused on smaller models. <a href="https://huggingface.co/Xenova/bge-small-en-v1.5">Bge-small-en-v1.5</a> is downloaded by default. We kept the option to use another model, <a href="https://huggingface.co/Xenova/all-MiniLM-L6-v2">all-MiniLM-L6-v2</a>, which may yield better results based on our tests. This app was built as a demo to illustrate real-life use cases of AI, working exclusively with basic building blocks in order to demystify this technology. Read about other solutions we tested to classify companies <a href="https://www.pitti.io/blogs">here</a>.</p>
            </div>
        </div>}
      <Footer/>
    </div>
